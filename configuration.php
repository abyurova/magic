...
class JConfig
{
	...
	public $user = 'lmiowl_jos5';                       // DB username
	public $password = 'F[yCuDr&1](Kyo0S*H(83(^9';                   // DB password
	public $db = 'lmiowl_jos5';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'wu7ZMs4eGHULbkFt';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_enable = '';
	public $tmp_path = '/home/lmiowl/ainur.owlstudio.kz/tmp';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '/home/lmiowl/ainur.owlstudio.kz/logs';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
