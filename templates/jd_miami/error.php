				...
				<div class="rt-block">
					...
					<div class="rt-error-content">
						...
						<div class="error-content">
							...
							<p><a href="<?php echo $gantry->baseUrl; ?>" class="readon" title="<?php echo JText::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>"><span><?php echo JText::_('JERROR_LAYOUT_HOME_PAGE'); ?></span></a></p>
					</div>
				</div>
			</div>
		</div>
